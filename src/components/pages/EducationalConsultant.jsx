...
export default function EducationalConsultant() {
  return (
    <Box sx={{ maxWidth: 700, mx: 'auto', mt: 4, p: 2 }}>
      <Card sx={{ mb: 3 }}>
        <CardMedia
          ...
          height="220"
          image="/education.jpg"
          alt="Educational Consultant"
        />
      </Card>
      <Button href="#services" variant="outlined" sx={{ mb: 2 }}>Back to Services</Button>
      <Typography variant="h4" fontWeight="bold" gutterBottom>Educational Consultant</Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        Expert guidance for your educational journey, from school selection and admissions to career planning.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
