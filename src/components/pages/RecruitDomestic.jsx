...
export default function RecruitDomestic() {
  return (
    <Box sx={{ maxWidth: 700, mx: 'auto', mt: 4, p: 2 }}>
      <Card sx={{ mb: 3 }}>
        <CardMedia
          ...
          height="220"
          image="/cleaners.jpg"
          alt="Recruiting of Domestic Workers"
        />
      </Card>
      <Button href="#services" variant="outlined" sx={{ mb: 2 }}>Back to Services</Button>
      <Typography variant="h4" fontWeight="bold" gutterBottom>Recruiting of Domestic Workers</Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        Find trustworthy and skilled domestic workers to help manage your home, from cleaning to childcare.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
