...
export default function RecruitDrivers() {
  return (
    <Box sx={{ maxWidth: 700, mx: 'auto', mt: 4, p: 2 }}>
      <Card sx={{ mb: 3 }}>
        <CardMedia
          ...
          height="220"
          image="/carDriver.jpg"
          alt="Recruiting of Drivers"
        />
      </Card>
      <Button href="#services" variant="outlined" sx={{ mb: 2 }}>Back to Services</Button>
      <Typography variant="h4" fontWeight="bold" gutterBottom>Recruiting of Drivers</Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        We recruit professional and reliable drivers for your personal and business needs, ensuring safety and efficiency.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
